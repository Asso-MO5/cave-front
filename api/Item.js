...
export class Item {
   ...
   */
  constructor({id, name, slug, description, release_year, cover_id, cover_url, type, author_id, status, created_at, updated_at, item_ref_id}) {
    /** @type {string} */
    this.id = id;
    /** @type {string} */
    this.name = name;
  ...
  set item_ref_id(value) {
    if (typeof value !== 'string') throw new TypeError('Expected a string for item_ref_id');
