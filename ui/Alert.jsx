...
export function Alert({
  ...
  const handleConfirm = async () => {
    await onConfirm?.()
    if (closeModalOnConfirm) handleClose()
  }
      ...
      >
        <div className="fixed inset-0 flex w-screen items-center justify-center p-4">
          ...
          >
            <DialogPanel
              className={dc(
                'z-[999] space-y-4 bg-mo-bg border-2 rounded-md p-4 flex flex-col justify-between min-h-32 mx-3 shadow-lg max-h-[calc(100dvh-4rem)]',
