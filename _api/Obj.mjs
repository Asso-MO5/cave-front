...
export class Obj   {
  ...
  constructor(props = {}) {
    ...
    /** @type {Model11} */
    this.medias = new Model11(medias);
  }
  ...
  set medias(value) {
    if (!(value instanceof Model11 && (typeof value === 'null' || typeof value === 'undefined'))) throw new TypeError('Expected an instance of Model11 for medias');
    this._medias = value;
  }
